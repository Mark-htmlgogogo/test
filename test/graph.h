...
public:
	...
	void Add_Node_Value(unordered_map<NODE, double>nodes_value, INDEX p) {
		for (auto i : Nodes) {
	...
	const unordered_map<NODE, double>& node_value() const { return Node_Value; }
...
private:
	...
	NODE_SET T_Terminal;
	/*  NODE Value  */
	unordered_map<NODE, double>Node_Value;
};
...
public:
	...
	const unordered_map<NODE, double>& nodes_value() const { return Node_Value; } // node weight 
